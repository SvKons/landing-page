...
$(document).ready(function () {
    function updateScale(slider, sliderClass) {
        const currentSlide = slider.slick('slickCurrentSlide');
        $(`${sliderClass} .slick-slide`).removeClass('scale-105');
        $(`${sliderClass} .slick-slide[data-slick-index="${currentSlide}"]`).addClass('scale-105');
    }

    // Слайдер для секции "Дисциплины"
    ...
    // Слайдер для секции "Жизнь вуза"
    const sliderLife = $('.slick-slider-life').slick({
        centerMode: true,
        variableWidth: true,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    sliderLife.on('afterChange', function () {
        updateScale(sliderLife, '.slick-slider-life');
    });

    sliderDisciplines.on('afterChange', function () {
        updateScale(sliderDisciplines, '.slick-slider-disciplines');
    });

    updateScale(sliderLife, '.slick-slider-life');
    updateScale(sliderDisciplines, '.slick-slider-disciplines');

    $('.slick-slider-life .slick-slide').on('click', function () {
        const index = $(this).data('slick-index');
        sliderLife.slick('slickGoTo', index);
        updateScale(sliderLife, '.slick-slider-life');
    });

    $('.slick-slider-disciplines .slick-slide').on('click', function () {
        const index = $(this).data('slick-index');
        sliderDisciplines.slick('slickGoTo', index);
        updateScale(sliderDisciplines, '.slick-slider-disciplines');
    });

    $('.slick-prev-disciplines').on('click', function () {
        sliderDisciplines.slick('slickPrev');
        updateScale(sliderDisciplines, '.slick-slider-disciplines');
    });

    $('.slick-next-disciplines').on('click', function () {
        sliderDisciplines.slick('slickNext');
        updateScale(sliderDisciplines, '.slick-slider-disciplines');
    });

    $('.slick-prev-life').on('click', function () {
        sliderLife.slick('slickPrev');
        updateScale(sliderLife, '.slick-slider-life');
    });

    $('.slick-next-life').on('click', function () {
        sliderLife.slick('slickNext');
        updateScale(sliderLife, '.slick-slider-life');
    });
});
